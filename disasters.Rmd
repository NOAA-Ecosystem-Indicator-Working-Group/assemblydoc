...
write.csv(Storm_Freq,file="C:/Users/... your path.../Billion_Dollar_Storms_1980_Present.csv")
rm(list=ls())

```

For more information, please contact Willem Klajbor (willem.klajbor@noaa.gov) or Geret DePiper (geret.depiper@noaa.gov).
